...
# ================= 1. SOZLAMALAR =================
TOKEN = '8618396186:AAGFYiNczGlvjjuytRAJW1WdtVWAD_5kFU8'  # AnorPlayBot tokeni
ADMIN_ID = 7704099453                        # Telegram ID'ingiz
MAIN_CHANNEL = "@AnorPlay"         # Asosiy AnorPlay kanali username'i
...
@app.route('/')
def home():
    return "AnorPlay Bot faol ishlamoqda!"
...
def callback_handler(call):
    ...
    if call.data == "add_movie":
        ...
        msg = (
            ...
            "**Masalan:**\n"
            "`@-100123456789` | `AnorPlay Uz` | `https://t.me/anorplayuz`"
        )
...
def handle_admin_inputs(message):
    ...
    if state == "waiting_channel_info":
        ...
        try:
            ...
            bot.send_message(message.chat.id, f"🎉 Kino saqlandi! Lekin kanalga yuborishda xato: {e}", parse_mode="Markdown")
...
if __name__ == "__main__":
    keep_alive()
    print("AnorPlay Bot ishga tushdi...")
